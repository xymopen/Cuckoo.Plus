<template>
  <div class="simple-action-bar">
    ...
    <div class="left-area">
      ...
      <div v-if="isOAuthUser" :style="activeReplyEntryStyle" class="active-reply-entry placeholder-read-text-color"
    ...
    <div class="right-area">
      <div class="plus-one operate-btn-group">
        ...
        <span v-if="operateCheckTargetStatus.favourites_count > 0"
          class="count">{{ operateCheckTargetStatus.favourites_count }}</span>
      </div>
      <div class="share operate-btn-group" v-if="shouldShowReblogButton">
        ...
        <span v-if="operateCheckTargetStatus.reblogs_count > 0"
          class="count">{{ operateCheckTargetStatus.reblogs_count }}</span>
      </div>
    </div>
