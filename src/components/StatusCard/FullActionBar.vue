  ...
  <div class="full-action-bar">
    <div class="reply-input-area">
      ...
      <div class="input-container">
        <cuckoo-input ref="cuckooInput" @submit="onSubmitReplyContent" @esc="onTryHideFullReplyActionArea"
          :shouldShowSpoilerTextInputArea="shouldShowSpoilerTextInputArea" :spoilerText.sync="replySpoilerTextValue"
          :text.sync="inputValue" :uploadProcesses.sync="uploadProcesses" :presetAtAccounts="presetAtAccounts"
    ...
    <div class="reply-action-area">
      <div class="left-area">
        ...
        <mu-button ref="visibilityTriggerBtn" @click.stop="shouldOpenVisibilitySelectPopOver = true"
          class="operate-btn change-visibility secondary-read-text-color" icon
          :title="$t($i18nTags.statusCard.change_visibility)">
        ...
        <mu-button @click.stop="shouldShowSpoilerTextInputArea = !shouldShowSpoilerTextInputArea" class="operate-btn" icon
      ...
      <div class="right-area">
        <mu-button flat class="operate-btn cancel" color="secondary"
          @click.stop="hideFullReplyActionArea">{{ $t($i18nTags.statusCard.cancel_post) }}</mu-button>
    ...
    <visibility-select-pop-over :visibility.sync="visibility" :open.sync="shouldOpenVisibilitySelectPopOver"
