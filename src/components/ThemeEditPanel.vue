<template>
  <div class="theme-edit-panel-container">
    <mu-dialog :open.sync="isDialogOpening" overlay-color="rgba(0,0,0,0.12)"
      dialog-class="theme-edit-dialog default-theme-bg-color" :width="dialogWidth" :overlay-close="false"
      ...
      <mu-button slot="actions" flat class="secondary-theme-text-color" @click="onTryToSaveTheme"
        :disabled="!hasColorChanged">Save</mu-button>
    ...
    <mu-popover cover :trigger="triggerPopOverElem" :open.sync="shouldOpenColorPickerPopOver">
