<template>
  <mu-dialog dialog-class="post-status-dialog-container" :open.sync="isDialogOpening" overlay-color="rgba(0,0,0,0.12)"
    :overlay-opacity="1" @close="onTryCloseDialog" :transition="transition" :width="dialogWidth"
    :fullscreen="shouldDialogFullScreen" v-loading="isPostLoading">
    ...
    <mu-appbar v-if="shouldDialogFullScreen" class="dialog-fullscreen-bar" color="primary">
      ...
      <mu-button slot="right" flat :disabled="!shouldEnableSubmitButton" @click="onSubmitNewStatus">
        ...
        <div class="user-and-status-info">
          ...
          <div class="visibility-row">
            ...
            <div class="visibility-info secondary-theme-text-color" ref="visibilitySelectBtn"
              ...
              {{ $t(visibility) }}
              <mu-icon size="18" class="visibility-icon secondary-read-text-color"
                :value="getVisibilityDescInfo(visibility).icon"></mu-icon>
            </div>
    ...
    <section>
      ...
      <cuckoo-input ref="cuckooInput" @submit="onSubmitNewStatus" @esc="onTryCloseDialog"
        :shouldShowSpoilerTextInputArea="shouldShowSpoilerTextInputArea" :spoilerText.sync="spoilerTextValue"
      ...
      <div class="bottom-area">
        ...
        <div class="attachment-select-btn-group">
          ...
          <mu-button @click="shouldShowSpoilerTextInputArea = !shouldShowSpoilerTextInputArea" class="operate-btn" icon
